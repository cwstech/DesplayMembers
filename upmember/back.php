...
try {
    ...
    // $mail->Username   = 'namraramsha2@gmail.com';                     //SMTP username
    $mail->Username   = 'no-reply@rct-rakshakgroupsurat.in';                     //SMTP username
    // $mail->Password   = 'ysbxnpfbumkgcqrf';                               //SMTP password
    $mail->Password   = 'Rakshak@Surat';                               //SMTP password
